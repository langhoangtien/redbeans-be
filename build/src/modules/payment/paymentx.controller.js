...
async function generateClientToken(_req, res) {
    try {
...
export async function createOrder(req, res) {
    try {
        ...
        const order = await axios.post(`${paypalApi}/v2/checkout/orders`, {
            intent: "CAPTURE",
            purchase_units: [
                {
                    amount: {
...
export async function captureOrder(req, res) {
    ...
    try {
        ...
        const accessToken = await getAccessToken();
        const { paypalApi } = config;
        const capture = await axios.post(`${paypalApi}/v2/checkout/orders/${orderID}/capture`, {}, {
            headers: {
                Authorization: `Bearer ${accessToken}`,
                "Content-Type": "application/json",
            },
...
//# sourceMappingURL=paymentx.controller.js.map